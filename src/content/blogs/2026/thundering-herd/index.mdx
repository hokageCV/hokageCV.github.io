...
import thundering_herd from "./thundering-herd.webp";
...
<CaptionImage
  src={thundering_herd}
  alt="Demonstration of thundering herd"
  caption="Thundering Herd: Lot of requests going to the same resource. Photo credit: Artificial Intelligence."
/>
