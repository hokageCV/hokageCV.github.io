...
import createToken from "./create-token.webp";
...
Or simply go to this link: [https://id.atlassian.com/manage-profile/security/api-tokens](https://id.atlassian.com/manage-profile/security/api-tokens).

In the page, click on 'create API token' button. In the popup, add token name and set expiration date.

<CaptionImage
  src={createToken}
  alt="Create token page"
  caption="Manager API Tokens page"
/>
